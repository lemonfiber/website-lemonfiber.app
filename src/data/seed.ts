...
export const seedRepos: Repo[] = [
  ...
  seed(
    ...
    "the binary",
    "Rust",
    "The Lemonfiber binary: sets up your media stack, runs it in slices, proves it works. Rust.",
    { primary: true, latestRelease: "v0.13.0" },
  ),
  seed(
    "lemonfiber-media-stack",
    "the stack",
    "Shell",
    "The Docker Compose stack it orchestrates — 19 services + the stack.toml manifest.",
    { primary: true },
  ),
  seed(
    "lemonfiber-web",
  ...
  seed(
    ...
    "placeholder",
    "Ruby",
    "brew install lemonfiber — a formula stub, generated by release CI once Homebrew publishing turns on.",
  ),
  seed(
  ...
  seed(
    ...
    "inherited",
    "Markdown",
    "Community health files, issue templates and the dependency policy every repo inherits.",
  ),
];
