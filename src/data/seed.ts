...
export const seedRepos: Repo[] = [
  ...
  seed("lemonfiber", "the binary", "Rust", "The Lemonfiber binary: sets up your media stack, runs it in slices, proves it works. Rust.", { primary: true, latestRelease: "v0.13.0" }),
