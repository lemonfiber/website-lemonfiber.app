...
export const seedMilestones: Milestone[] = [
  ...
  at("M1", "lemonfiber-media-stack standalone", "partial", 0, 0),
  at("M2", "Core: manifest, compose driver, CLI", "done", 9, 9),
  at("M3", "Setup wizard + doctor", "partial", 44, 44),
  at("M4", "Seed & backup", "partial", 18, 19),
  at("M5", "Trust checks", "partial", 6, 6),
  at("M6", "Live TUI", "partial", 27, 32),
  at("M7", "Web surface & UX", "partial", 106, 107),
  at("M8", "Household & content", "todo", 0, 0),
  at("M9", "Lifecycle & maintenance", "partial", 15, 15),
  at("M10", "Release engineering", "partial", 0, 7),
];
